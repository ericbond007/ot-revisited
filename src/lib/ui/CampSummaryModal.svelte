...
<style>
  ...
  .stat-val .small { color: var(--c-wood); font-style: italic; font-size: 0.85em; }
  ...
  .name { color: var(--c-tan-bright); font-weight: 700; }
  .health { color: var(--c-tan); display: inline-flex; align-items: baseline; gap: 0.3em; font-size: 0.92em; }
  .tag {
    font-size: 0.7em;
  ...
  .tag.died { background: #e85a4a; color: var(--c-tan-bright); }
  .tag.dead { color: var(--c-wood); font-style: italic; }
