<!-- SodaSpringsArt.svelte — auto-ported from soda-springs-art.jsx -->
<script lang="ts">
...
{#snippet smallWagonSS(x: number, y: number)}
  <g transform={`translate(${x}, ${y})`}>
    <rect x="0" y="0" width="14" height="5" fill={LMK.earth} stroke={ink} stroke-width="0.35" />
    <path d="M 0 0 Q 7 -8 14 0 Z" fill={LMK.white} stroke={ink} stroke-width="0.45" />
    <circle cx="3" cy="6" r="1.8" fill="none" stroke={ink} stroke-width="0.35" />
    <circle cx="11" cy="6" r="1.8" fill="none" stroke={ink} stroke-width="0.35" />
  </g>
{/snippet}
...
<g>
  ...
  <path
    ...
    fill={pineDark} opacity="0.5" stroke={ink} stroke-width="0.4"
  />
  <g opacity="0.45" stroke={ink} stroke-width="0.3">
    {#each Array(60) as _, i}
      {@const x = 8 + (i * 8) % 470}
      {@const y = 70 + (i % 4) * 4}
      <line x1={x} y1={y} x2={x} y2={y - 2.5} />
    {/each}
  </g>
  <path
  ...
  <g>
    <path
      ...
      stroke={LMK.water} stroke-width="6" fill="none" opacity="0.85"
    />
    <path
      d="M 0 118 Q 80 116 140 122 Q 200 128 270 124 Q 340 120 400 124 Q 440 126 480 122"
    ...
    <path d="M 60 116 q 8 -1 16 0 m 80 7 q 8 -0.5 16 0 m 100 -3 q 8 -1 16 0"
      stroke={LMK.paperWarm} stroke-width="0.5" fill="none" opacity="0.6" />
    {#each [34, 110, 200, 296, 376, 444] as cx, i}
      <ellipse cx={cx} cy={i % 2 ? 116 : 124} rx="5" ry="2.5"
        fill={LMK.sageDark} stroke={ink} stroke-width="0.3" />
    {/each}
  </g>

  <!-- HERO: mineral cones / soda springs -->
  <g>
    <!-- Steamboat Spring -->
    <g>
      <path
        d="M 200 148 Q 210 130 222 116 Q 230 106 240 104 Q 250 106 258 116 Q 270 130 280 148 Z"
        fill={traverLight} stroke={ink} stroke-width="0.7"
      />
      <path
        d="M 240 104 Q 250 106 258 116 Q 270 130 280 148 L 240 148 Z"
        fill={traverRust} opacity="0.55"
      />
      <g opacity="0.65" stroke={traverDark} stroke-width="0.4" fill="none">
      ...
      <g opacity="0.5" fill={traverDark}>
        {#each Array(18) as _, i}
          {@const x = 208 + (i * 11) % 64}
          {@const y = 110 + ((i * 7) % 36)}
          <circle cx={x} cy={y} r={0.4} />
        {/each}
      </g>
      <ellipse cx="240" cy="104" rx="3" ry="1.2" fill={ink} opacity="0.85" />
      <g opacity="0.7" stroke={LMK.paperWarm} fill="none" stroke-width="1.2" stroke-linecap="round">
    ...
    <g>
      <path
        ...
        fill={traverLight} stroke={ink} stroke-width="0.6"
      />
      <path
        d="M 158 124 Q 164 124 170 130 Q 178 138 186 148 L 158 148 Z"
        fill={traverRust} opacity="0.5"
      />
      <g opacity="0.6" stroke={traverDark} stroke-width="0.35" fill="none">
      ...
      <path d="M 158 122 q -1.5 -4 0.5 -8 q 1 -3 -0.5 -6"
        stroke={LMK.paperWarm} stroke-width="0.6" fill="none" opacity="0.55" />
    </g>
    ...
    <g>
      <path
        ...
        fill={traverLight} stroke={ink} stroke-width="0.5"
      />
      <path
        d="M 330 130 Q 335 130 340 134 Q 346 140 352 148 L 330 148 Z"
        fill={traverRust} opacity="0.5"
      />
      <g opacity="0.6" stroke={traverDark} stroke-width="0.3" fill="none">
  ...
  <!-- Pioneers at the springs -->
  <g>
    <g transform="translate(150, 150)">
      <ellipse cx="0" cy="-1" rx="1" ry="1.2" fill={LMK.paperWarm} stroke={ink} stroke-width="0.25" />
      <ellipse cx="0" cy="-2" rx="1.6" ry="0.3" fill={ink} />
      <path d="M -1.2 0 L 1.2 0 L 1.5 4 L -1.5 4 Z" fill={LMK.earth} stroke={ink} stroke-width="0.25" />
      <line x1="1.2" y1="2" x2="3" y2="3.5" stroke={ink} stroke-width="0.4" />
      <rect x="2.8" y="3" width="1.2" height="2" fill={tan} stroke={ink} stroke-width="0.2" />
    </g>
    <g transform="translate(166, 152)">
      <ellipse cx="0" cy="-1" rx="1" ry="1.2" fill={LMK.paperWarm} stroke={ink} stroke-width="0.25" />
      <ellipse cx="0" cy="-2" rx="1.5" ry="0.3" fill={LMK.earthDark} />
      <path d="M -1.2 0 L 1.2 0 L 1.4 4 L -1.4 4 Z" fill={LMK.rust} stroke={ink} stroke-width="0.25" />
      <line x1="-1.2" y1="2" x2="-3" y2="3.5" stroke={ink} stroke-width="0.4" />
      <rect x="-4" y="3" width="1.2" height="2" fill={tan} stroke={ink} stroke-width="0.2" />
    </g>
    <g transform="translate(196, 152)">
      <ellipse cx="0" cy="-3" rx="0.9" ry="1.1" fill={LMK.paperWarm} stroke={ink} stroke-width="0.25" />
      <ellipse cx="0" cy="-4" rx="1.5" ry="0.3" fill={ink} />
      <path d="M -1.2 -2 L 1.2 -2 L 1 2 L -1 2 Z" fill={LMK.earthDark} stroke={ink} stroke-width="0.25" />
      <line x1="-0.6" y1="2" x2="-0.6" y2="6" stroke={ink} stroke-width="0.4" />
      <line x1="0.6" y1="2" x2="0.6" y2="6" stroke={ink} stroke-width="0.4" />
      <line x1="1" y1="-1.5" x2="3" y2="-4" stroke={ink} stroke-width="0.5" stroke-linecap="round" />
    </g>
    <g transform="translate(220, 154)">
      <ellipse cx="0" cy="-3" rx="0.9" ry="1.1" fill={LMK.paperWarm} stroke={ink} stroke-width="0.25" />
      <path d="M -1.2 -2 L 1.2 -2 L 1 2 L -1 2 Z" fill={LMK.earth} stroke={ink} stroke-width="0.25" />
      <line x1="-0.6" y1="2" x2="-0.6" y2="6" stroke={ink} stroke-width="0.4" />
      <line x1="0.6" y1="2" x2="0.6" y2="6" stroke={ink} stroke-width="0.4" />
    </g>
    <g transform="translate(264, 156)">
      ...
      <path d="M -1.2 -2 L 1.2 -2 L 1 2 L -1 2 Z" fill={LMK.rust} stroke={ink} stroke-width="0.25" />
      <line x1="-0.6" y1="2" x2="-0.6" y2="6" stroke={ink} stroke-width="0.4" />
      <line x1="0.6" y1="2" x2="0.6" y2="6" stroke={ink} stroke-width="0.4" />
    </g>
  </g>
  ...
  <path d="M 0 168 Q 100 166 200 170 Q 300 168 400 170 Q 450 169 480 170"
    stroke={LMK.earth} stroke-width="1" fill="none" opacity="0.45" />
  <g opacity="0.6">
    {#each [14, 60, 100, 360, 400, 440, 460] as x, i}
      {@const y = 174 + (i % 3) * 6}
      <g transform={`translate(${x}, ${y})`}>
        <ellipse cx="0" cy="0" rx="2.6" ry="1.2" fill={LMK.sage} stroke={ink} stroke-width="0.25" />
        <ellipse cx="-1" cy="-0.7" rx="1.4" ry="0.7" fill={LMK.sageLight} stroke={ink} stroke-width="0.2" />
      </g>
    {/each}
  </g>

  <!-- Wagons stopped + oxen drinking -->
  <g>
    {@render smallWagonSS(36, 172)}
    {@render smallWagonSS(80, 170)}
    <g transform="translate(54, 130)">
      <ellipse cx="0" cy="0" rx="3" ry="1.6" fill={LMK.earthLight} stroke={ink} stroke-width="0.3" />
      <ellipse cx="2.6" cy="1.4" rx="1.4" ry="1" fill={LMK.earthLight} stroke={ink} stroke-width="0.3" />
      <line x1="-2" y1="1.5" x2="-2" y2="3.5" stroke={ink} stroke-width="0.4" />
      <line x1="1" y1="1.5" x2="1" y2="3.5" stroke={ink} stroke-width="0.4" />
    </g>
    <g transform="translate(74, 132)">
      <ellipse cx="0" cy="0" rx="3" ry="1.6" fill={LMK.earth} stroke={ink} stroke-width="0.3" />
      <ellipse cx="2.6" cy="1.4" rx="1.4" ry="1" fill={LMK.earth} stroke={ink} stroke-width="0.3" />
      <line x1="-2" y1="1.5" x2="-2" y2="3.5" stroke={ink} stroke-width="0.4" />
      <line x1="1" y1="1.5" x2="1" y2="3.5" stroke={ink} stroke-width="0.4" />
    </g>
  </g>
