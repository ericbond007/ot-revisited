...
<g>
  ...
  <g>
    <rect x="0" y="14" width={LMK_VIEW_W} height="142" fill={stone} stroke={ink} stroke-width="0.7" />
    ...
    <!-- horizontal bedding -->
    <g stroke={stoneSh} stroke-width="0.45" fill="none" opacity="0.55">
    ...
    <!-- vertical fissures -->
    <g stroke={stoneShDeep} stroke-width="0.5" fill="none" opacity="0.6">
  ...
  <g font-family="IM Fell English, Georgia, serif" fill={stoneShDeep} font-style="italic">
    {#each names as n, i}
      <text x={n.x} y={n.y} font-size={n.s}
  ...
  <g stroke={stoneShDeep} stroke-width="0.3" opacity="0.4" fill="none">
  ...
  <g transform="translate(150 134)">
    ...
    <path d="M -1 -1 L 1 -1 L 1.4 -5 L -1.4 -5 Z" fill={LMK.earthDark} stroke={ink} stroke-width="0.3" />
    <ellipse cx="0" cy="-6" rx="0.8" ry="0.9" fill={LMK.paperWarm} stroke={ink} stroke-width="0.25" />
    <!-- arm raised w/ knife -->
    <line x1="0.6" y1="-5" x2="2.5" y2="-9" stroke={ink} stroke-width="0.35" />
    <line x1="2.5" y1="-9" x2="3.5" y2="-10" stroke={ink} stroke-width="0.4" />
  </g>

  <!-- ground & river at base -->
  <g>
    <rect x="0" y="156" width={LMK_VIEW_W} height="6" fill={stoneSh} stroke={ink} stroke-width="0.4" />
    <rect x="0" y="162" width={LMK_VIEW_W} height="14" fill={LMK.water} opacity="0.7" />
    <g stroke={LMK.white} stroke-width="0.35" opacity="0.55">
