<!--
  GreenRiverArt.svelte — major crossing west of South Pass, near Lombard Ferry
...
{#snippet bankWagon(x: number, y: number, opacity: number)}
...
<g>
  ...
  <g>
    <path d="M 0 70 L 40 56 L 90 64 L 150 50 L 220 60 L 290 52 L 360 62 L 420 56 L 480 64 L 480 96 L 0 96 Z"
          fill={redRock} stroke={ink} stroke-width="0.55" opacity="0.85" />
    <path d="M 0 96 Q 80 92 160 96 Q 240 92 320 96 Q 400 92 480 96 L 480 104 L 0 104 Z"
          fill={redRockSh} opacity="0.65" />
    <!-- strata -->
    <g stroke={redRockSh} stroke-width="0.4" fill="none" opacity="0.55">
  ...
  <!-- far cottonwoods -->
  <g>
    {#each [40, 90, 180, 260, 360, 430] as x, i}
      <g>
        <ellipse cx={x} cy={108 + (i % 2) * 2} rx="9" ry="6" fill={LMK.sageDark} stroke={ink} stroke-width="0.4" />
        <rect x={x - 1} y={114 + (i % 2) * 2} width="2" height="6" fill="#4a3220" stroke={ink} stroke-width="0.3" />
      </g>
    {/each}
  </g>
  ...
  <g>
    ...
    <!-- flow lines -->
    <g stroke={LMK.white} stroke-width="0.4" opacity="0.5">
  ...
  <g transform="translate(240 130)">
    ...
    <path d="M -32 0 L -28 -3 L 28 -3 L 32 0 L 28 3 L -28 3 Z"
          fill="#5a3a1a" stroke={ink} stroke-width="0.6" />
    <g stroke="#3a2410" stroke-width="0.4" opacity="0.7">
      <line x1="-28" y1="-1" x2="28" y2="-1" />
      <line x1="-28" y1="1" x2="28" y2="1" />
    </g>
    <!-- wagon on barge -->
    <g transform="translate(0 -10)">
      <rect x="-10" y="-3" width="20" height="3" fill={LMK.earth} stroke={ink} stroke-width="0.5" />
      <path d="M -10 -3 Q 0 -12 10 -3 Z" fill={LMK.white} stroke={ink} stroke-width="0.5" />
    </g>
    <!-- ferry post + rope -->
    <line x1="-18" y1="-3" x2="-18" y2="-12" stroke={ink} stroke-width="0.6" />
    <line x1="18" y1="-3" x2="18" y2="-12" stroke={ink} stroke-width="0.6" />
    <!-- sweep oars -->
    <line x1="-32" y1="0" x2="-44" y2="6" stroke={ink} stroke-width="0.5" />
    <line x1="32" y1="0" x2="44" y2="6" stroke={ink} stroke-width="0.5" />
  </g>

  <!-- queue of wagons on near bank -->
  <g>
    {@render bankWagon(86, 158, 1)}
    {@render bankWagon(134, 158, 1)}
    {@render bankWagon(178, 158, 0.95)}
    <!-- people -->
    <g transform="translate(110 158)">
      <ellipse cx="0" cy="-4" rx="0.8" ry="0.9" fill={LMK.paperWarm} stroke={ink} stroke-width="0.25" />
      <path d="M -0.9 -3 L 0.9 -3 L 1.1 0 L -1.1 0 Z" fill={LMK.earthDark} stroke={ink} stroke-width="0.25" />
    </g>
  </g>
