<!--
  AlcoveSpringArt.svelte — mile ~110, near the Big Blue / Independence Crossing
...
<g>
  ...
  <g>
    ...
    <path d="M 56 80 L 54 60 L 62 60 L 60 80 Z" fill="#4a3220" stroke={ink} stroke-width="0.4" />
    <path d="M 416 80 L 414 60 L 422 60 L 420 80 Z" fill="#4a3220" stroke={ink} stroke-width="0.4" />
    <!-- names carved into the left trunk -->
    <text x="58" y="74" font-size="3" font-family="IM Fell English, Georgia, serif"
          fill={ink} text-anchor="middle" font-style="italic" opacity="0.7">J·F·R</text>
    <text x="58" y="78" font-size="2.5" font-family="IM Fell English, Georgia, serif"
          fill={ink} text-anchor="middle" font-style="italic" opacity="0.6">'46</text>
  </g>
  ...
  <g>
    ...
    <g stroke={stoneShadow} stroke-width="0.4" fill="none" opacity="0.55">
    ...
    <g fill={moss} opacity="0.7">
      ...
      <!-- hanging vines -->
      <path d="M 170 88 q 0 6 -2 10" stroke={moss} stroke-width="0.5" fill="none" />
      <path d="M 200 88 q 0 8 1 12" stroke={moss} stroke-width="0.5" fill="none" />
      <path d="M 280 88 q 0 8 -1 12" stroke={moss} stroke-width="0.5" fill="none" />
      <path d="M 310 88 q 0 6 2 10" stroke={moss} stroke-width="0.5" fill="none" />
    </g>

    <!-- CARVED NAMES on the cliff face — the inscription record -->
    <g opacity="0.75">
      <text x="160" y="116" font-size="3.5" font-family="IM Fell English, Georgia, serif"
            fill={stoneShadow} font-style="italic">ALCOVE SPRING</text>
      <text x="200" y="124" font-size="2.6" font-family="IM Fell English, Georgia, serif"
            fill={stoneShadow} font-style="italic">Bryant · 1846</text>
      <text x="262" y="116" font-size="2.6" font-family="IM Fell English, Georgia, serif"
            fill={stoneShadow} font-style="italic">J·F·Reed</text>
      <text x="290" y="124" font-size="2.4" font-family="IM Fell English, Georgia, serif"
            fill={stoneShadow} font-style="italic">Donner</text>
      <text x="232" y="132" font-size="2.4" font-family="IM Fell English, Georgia, serif"
            fill={stoneShadow} font-style="italic" text-anchor="middle">Whitman · '43</text>
    </g>
    ...
    <g>
      ...
      <path d="M 230 92 L 232 136" stroke={LMK.white} stroke-width="0.5" opacity="0.7" />
      <path d="M 236 90 L 238 136" stroke={LMK.white} stroke-width="0.4" opacity="0.55" />
      <path d="M 244 92 L 246 136" stroke={LMK.white} stroke-width="0.45" opacity="0.65" />
    </g>
  </g>

  <!-- basin pool below -->
  <g>
    <ellipse cx="240" cy="148" rx="62" ry="10" fill={LMK.water} opacity="0.7" stroke={ink} stroke-width="0.5" />
    <ellipse cx="240" cy="146" rx="56" ry="6" fill="#a8c4c8" opacity="0.5" />
    <!-- splash + ripples -->
    <ellipse cx="238" cy="143" rx="6" ry="1.4" fill={LMK.white} opacity="0.7" />
    <g stroke={LMK.white} stroke-width="0.4" fill="none" opacity="0.6">
      <ellipse cx="240" cy="148" rx="40" ry="6.5" />
      <ellipse cx="240" cy="148" rx="50" ry="8" />
    </g>
    <!-- outlet stream toward Big Blue -->
    <path d="M 296 152 Q 360 156 420 158 Q 460 159 480 160" stroke={LMK.water} stroke-width="2" fill="none" opacity="0.7" />
    <path d="M 184 152 Q 120 156 60 158 Q 20 159 0 160" stroke={LMK.water} stroke-width="2" fill="none" opacity="0.7" />
  </g>

  <!-- undergrowth at base of cliff -->
  <g>
    {#each [140, 168, 198, 280, 312, 342] as x, i}
      <g transform="translate({x},{140 + (i % 2) * 2})">
        <ellipse cx="0" cy="0" rx="6" ry="2.4" fill={leaf} stroke={ink} stroke-width="0.35" />
  ...
  <g transform="translate(96 156)">
    <path d="M -3 0 Q 0 -4 3 0 L 4 1 L -4 1 Z" fill={LMK.white} stroke={ink} stroke-width="0.4" />
    <path d="M -4 1 L 4 1 L 5 2 L -5 2 Z" fill={LMK.parchmentSh} stroke={ink} stroke-width="0.3" />
  ...
  <g opacity="0.6" stroke={LMK.sageDark} stroke-width="0.4" fill="none">
    {#each [20, 60, 110, 350, 400, 450] as x, i}
      {@const y = 174 + (i % 3) * 4}
