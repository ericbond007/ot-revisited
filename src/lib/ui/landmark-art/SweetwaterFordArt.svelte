...
{#snippet ox2(color: string)}
  <g>
    <ellipse cx="0" cy="-3" rx="4.5" ry="2.2" fill={color} stroke={ink} stroke-width="0.4" />
    <ellipse cx="3.6" cy="-4" rx="1.4" ry="1.2" fill={color} stroke={ink} stroke-width="0.35" />
    <line x1="-2.6" y1="-1" x2="-2.6" y2="2" stroke={ink} stroke-width="0.5" />
    <line x1="-1" y1="-1" x2="-1" y2="2" stroke={ink} stroke-width="0.5" />
    <line x1="1" y1="-1" x2="1" y2="2" stroke={ink} stroke-width="0.5" />
    <line x1="2.8" y1="-1" x2="2.8" y2="2" stroke={ink} stroke-width="0.5" />
    <path d="M 4 -5 q 0.8 -1.4 2 -1" stroke={ink} stroke-width="0.4" fill="none" />
    <path d="M 3 -5 q -0.5 -1.4 -1.6 -1" stroke={ink} stroke-width="0.4" fill="none" />
  </g>
{/snippet}
...
<g>
  ...
  <g>
    <path d="M 30 110 Q 28 90 52 78 Q 80 70 100 80 Q 110 95 96 110 Z"
          fill={granite} stroke={ink} stroke-width="0.7" />
    <path d="M 50 80 Q 80 76 100 84 L 96 96 Q 70 92 48 100 Z"
          fill={graniteSh} opacity="0.55" />
    <!-- fissures -->
    <g stroke={graniteSh} stroke-width="0.4" fill="none" opacity="0.6">
  ...
  <g>
    <path d="M 100 110 Q 160 116 220 112 Q 300 108 360 116 Q 420 122 480 118 L 480 130 Q 420 134 360 128 Q 300 120 220 124 Q 160 128 100 122 Z"
          fill={LMK.water} opacity="0.7" stroke="#5a7280" stroke-width="0.4" />
    <!-- glints -->
    <g stroke={LMK.white} stroke-width="0.4" opacity="0.6">
    ...
    <!-- pebbles in shallows -->
    <g fill={graniteSh} opacity="0.55" stroke={ink} stroke-width="0.2">
  ...
  <g transform="translate(310 124)">
    ...
    <ellipse cx="0" cy="-3" rx="0.7" ry="0.8" fill={LMK.paperWarm} stroke={ink} stroke-width="0.25" />
    <path d="M -0.8 -2 L 0.8 -2 L 1 1 L -1 1 Z" fill={LMK.rust} stroke={ink} stroke-width="0.25" />
  </g>
  <g transform="translate(322 122)">
    <ellipse cx="0" cy="0" rx="1.6" ry="0.6" fill={LMK.water} opacity="0.7" />
    <ellipse cx="0" cy="-3" rx="0.7" ry="0.8" fill={LMK.paperWarm} stroke={ink} stroke-width="0.25" />
    <path d="M -0.8 -2 L 0.8 -2 L 1 1 L -1 1 Z" fill="#3a5a78" stroke={ink} stroke-width="0.25" />
  </g>
  ...
  <path d="M 0 162 Q 120 160 240 164 Q 360 162 480 166" stroke={LMK.earth} stroke-width="0.9" fill="none" opacity="0.4" />
  <g opacity="0.6">
    {#each [16, 56, 116, 270, 350, 440] as x, i}
      <g transform="translate({x},{172 + (i % 2) * 4})">
