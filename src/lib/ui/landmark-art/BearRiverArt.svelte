<!--
  BearRiverArt.svelte — meandering river through wide green valley near Soda Springs
...
{#snippet restingWagon(x: number, y: number)}
...
<g>
  ...
  <path d="M 0 56 L 50 36 L 90 50 L 140 30 L 200 50 L 260 38 L 320 52 L 380 36 L 440 50 L 480 44 L 480 84 L 0 84 Z"
        fill="#8a98a8" stroke={ink} stroke-width="0.5" opacity="0.85" />
  <path d="M 0 84 Q 80 78 160 82 Q 240 76 320 82 Q 400 78 480 82 L 480 92 L 0 92 Z"
        fill="#5a6878" opacity="0.6" />

  <!-- mid pines -->
  <g>
    {#each [40, 80, 130, 240, 320, 400, 450] as x, i}
      <g transform="translate({x},{94 + (i % 3) * 2})">
        <path d="M 0 0 L -3 -10 L 3 -10 Z" fill={meadowDark} stroke={ink} stroke-width="0.3" />
  ...
  <g>
    {#each [20, 30, 38, 48, 60, 75, 88, 102, 116, 132] as x, i}
      <g>
        <ellipse cx={x} cy={108 + (i % 3) * 2} rx="5" ry="7" fill={aspen} opacity="0.85" stroke={ink} stroke-width="0.3" />
        <ellipse cx={x - 1} cy={106 + (i % 3) * 2} rx="2" ry="3" fill={aspenLight} opacity="0.7" />
        <line x1={x} y1={114 + (i % 3) * 2} x2={x} y2={120 + (i % 3) * 2} stroke="#e8e0c8" stroke-width="0.5" />
      </g>
    {/each}
  </g>
  ...
  <g>
    ...
    <g stroke={meadowDark} stroke-width="0.35" fill="none" opacity="0.6">
      {#each Array(50) as _, i}
        {@const x = 4 + (i * 9.4) % 480}
        {@const y = 134 + ((i * 7) % 24)}
        <path d={`M ${x} ${y} q 0.5 -2 1 -3.5 m -0.5 3.5 q 1 -2 1.6 -3 m -1 3 q 0 -2 -0.8 -3.5`} />
      {/each}
    </g>
  </g>
  ...
  <g>
    <path d="M 60 138 Q 140 130 200 142 Q 260 154 340 144 Q 400 138 480 148"
          stroke={LMK.water} stroke-width="6" fill="none" opacity="0.75" stroke-linecap="round" />
    <path d="M 60 138 Q 140 130 200 142 Q 260 154 340 144 Q 400 138 480 148"
          stroke="#5a7280" stroke-width="0.6" fill="none" opacity="0.7" />
    <!-- shimmer along river -->
  ...
  <g>
    {@render restingWagon(150, 158)}
    {@render restingWagon(196, 160)}
    {@render restingWagon(244, 162)}
    <!-- campfire -->
    <g transform="translate(290 168)">
      <ellipse cx="0" cy="2" rx="3.5" ry="1" fill={LMK.earthDark} opacity="0.6" />
      <path d="M -1 0 q 0.5 -2 1 -3.5 q 0.5 -2 1 -3.5" stroke="#f6cc60" stroke-width="0.5" fill="none" />
      <path d="M 0 0 q 0.5 -3 1.5 -5" stroke="#f4a832" stroke-width="0.6" fill="none" />
      <line x1="-2" y1="2" x2="2" y2="2" stroke={ink} stroke-width="0.4" />
    </g>
    <!-- grazing oxen -->
    <g transform="translate(360 162)">
      <ellipse cx="0" cy="-3" rx="3.5" ry="1.7" fill="#5a3a1a" stroke={ink} stroke-width="0.4" />
      <ellipse cx="3" cy="-4" rx="1.2" ry="1" fill="#5a3a1a" stroke={ink} stroke-width="0.35" />
      <line x1="-2" y1="-1" x2="-2" y2="2" stroke={ink} stroke-width="0.45" />
      <line x1="-0.5" y1="-1" x2="-0.5" y2="2" stroke={ink} stroke-width="0.45" />
      <line x1="1" y1="-1" x2="1" y2="2" stroke={ink} stroke-width="0.45" />
      <line x1="2.5" y1="-1" x2="2.5" y2="2" stroke={ink} stroke-width="0.45" />
    </g>
    <g transform="translate(390 164)" opacity="0.85">
      <ellipse cx="0" cy="-3" rx="3" ry="1.5" fill="#3a2818" stroke={ink} stroke-width="0.4" />
      <ellipse cx="2.7" cy="-4" rx="1.1" ry="1" fill="#3a2818" stroke={ink} stroke-width="0.35" />
      <line x1="-1.5" y1="-1.5" x2="-1.5" y2="1.5" stroke={ink} stroke-width="0.45" />
      <line x1="0" y1="-1.5" x2="0" y2="1.5" stroke={ink} stroke-width="0.45" />
      <line x1="1.5" y1="-1.5" x2="1.5" y2="1.5" stroke={ink} stroke-width="0.45" />
      <line x1="2.7" y1="-1.5" x2="2.7" y2="1.5" stroke={ink} stroke-width="0.45" />
    </g>
  </g>
