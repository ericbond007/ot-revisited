<!--
  DevilsGateArt.svelte — mile ~820, just 5 mi past Independence Rock.
...
{#snippet smallWagonDG(x: number, y: number, opacity: number = 1)}
  <g transform="translate({x}, {y})" opacity={opacity}>
    <!-- small ox team -->
    <g transform="translate(-9, 0)">
      <ellipse cx="0" cy="2" rx="2.4" ry="1.3" fill={LMK.earthLight} stroke={ink} stroke-width="0.3" />
      <ellipse cx="2" cy="1.4" rx="1" ry="0.8" fill={LMK.earthLight} stroke={ink} stroke-width="0.3" />
    </g>
    <g transform="translate(-16, 0)">
      <ellipse cx="0" cy="2" rx="2.4" ry="1.3" fill={LMK.earth} stroke={ink} stroke-width="0.3" />
      <ellipse cx="2" cy="1.4" rx="1" ry="0.8" fill={LMK.earth} stroke={ink} stroke-width="0.3" />
    </g>
...
{#snippet smallPersonGazing(x: number, y: number, hat: boolean = false)}
  <g transform="translate({x}, {y})">
    <!-- head tilted UP — looking at the cleft -->
    <circle cx="0" cy="-3" r="0.9" fill={LMK.paperWarm} stroke={ink} stroke-width="0.2" />
    {#if hat}<ellipse cx="0" cy="-4" rx="1.5" ry="0.3" fill={ink} />{/if}
    <path d="M -1.2 -2 L 1.2 -2 L 1 2 L -1 2 Z" fill={LMK.earthDark} stroke={ink} stroke-width="0.25" />
    <line x1="-0.6" y1="2" x2="-0.6" y2="5" stroke={ink} stroke-width="0.4" />
    <line x1="0.6" y1="2" x2="0.6" y2="5" stroke={ink} stroke-width="0.4" />
  </g>
{/snippet}
...
<g>
  ...
  <g>
    ...
    <path
      ...
      fill={graniteLight} stroke={ink} stroke-width="0.9"
    />
    ...
    <g opacity="0.55" stroke={graniteMid} fill="none" stroke-width="0.4">
    ...
    <g opacity="0.55" stroke={graniteDark} fill="none" stroke-width="0.5">
    ...
    <g>
      {#each [[40, 32], [70, 28], [98, 26], [130, 30], [56, 38], [88, 34], [120, 30]] as [px, py]}
        <path d="M {px - 1.4} {py + 1} L {px} {py - 2} L {px + 1.4} {py + 1} Z"
          fill="#3a4a2a" stroke={ink} stroke-width="0.2" />
      {/each}
    </g>
  </g>
  ...
  <g>
    ...
    <g opacity="0.6" stroke={ink} fill="none" stroke-width="0.4">
  ...
  <g>
    ...
    <!-- pines -->
    <g>
      {#each [[300, 26], [330, 22], [360, 26], [392, 34], [424, 48], [310, 36], [346, 32], [378, 36], [408, 50]] as [px, py]}
        <path d="M {px - 1.4} {py + 1} L {px} {py - 2} L {px + 1.4} {py + 1} Z"
          fill="#3a4a2a" stroke={ink} stroke-width="0.2" />
      {/each}
    </g>
  ...
  <g>
    ...
    <path
      ...
      fill={LMK.water} stroke={ink} stroke-width="0.5" opacity="0.85"
    />
    ...
    <!-- downstream wake -->
    <g opacity="0.7" stroke={LMK.paperWarm} fill="none" stroke-width="0.5">
      <path d="M 270 144 q 4 -1 8 0 q 4 -1 8 0 q 4 -1 8 0" />
      <path d="M 296 145 q 6 -0.5 12 0 q 6 -0.5 12 0" />
    </g>
    <!-- upstream water highlights -->
    <g opacity="0.55" stroke="#5a7280" fill="none" stroke-width="0.4">
    ...
    <!-- willows on banks -->
    <ellipse cx="60" cy="148" rx="6" ry="2.5" fill={LMK.sageDark} stroke={ink} stroke-width="0.3" />
    <ellipse cx="160" cy="149" rx="5" ry="2.5" fill={LMK.sageDark} stroke={ink} stroke-width="0.3" />
    <ellipse cx="328" cy="149" rx="5" ry="2.5" fill={LMK.sageDark} stroke={ink} stroke-width="0.3" />
    <ellipse cx="436" cy="149" rx="6" ry="2.5" fill={LMK.sageDark} stroke={ink} stroke-width="0.3" />
  </g>
  ...
  <path
    ...
    stroke={LMK.earth} stroke-width="1.2" fill="none" opacity="0.6"
  />
  <path
    d="M 0 184 Q 100 182 200 186 Q 280 190 340 181 Q 400 168 450 164"
    stroke={LMK.earth} stroke-width="0.8" fill="none" opacity="0.5"
  />
  <text x="392" y="155" text-anchor="middle"
    font-family="IM Fell English, Georgia, serif" font-size="6"
    fill={inkSoft} font-style="italic" opacity="0.55">
    trail bypass
  </text>

  <!-- sage clumps -->
  <g opacity="0.6">
    {#each [16, 56, 100, 140, 200, 260, 380, 420] as x, i}
      {@const y = 168 + (i % 3) * 6}
      <g transform="translate({x}, {y})">
        <ellipse cx="0" cy="0" rx="3" ry="1.4" fill={LMK.sage} stroke={ink} stroke-width="0.3" />
        <ellipse cx="-1.2" cy="-0.8" rx="1.6" ry="0.9" fill={LMK.sageLight} stroke={ink} stroke-width="0.25" />
      </g>
    {/each}
  </g>
  ...
  <g>
    {@render smallWagonDG(120, 172)}
    {@render smallWagonDG(86, 174)}
    {@render smallWagonDG(56, 176, 0.95)}

    <!-- small group of figures who walked over to gawk -->
    <g transform="translate(180, 188)">
      {@render smallPersonGazing(0, 0)}
      {@render smallPersonGazing(10, 2, true)}
      {@render smallPersonGazing(20, 1)}
      {@render smallPersonGazing(32, 0, true)}
    </g>
  </g>
