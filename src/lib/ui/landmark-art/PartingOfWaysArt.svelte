<!--
  PartingOfWaysArt — the trail forks: Sublette Cutoff vs. Fort Bridger
...
<g>
  ...
  <g opacity="0.5">
    {#each Array(28) as _, i}
      {@const x = 8 + (i * 17) % 480}
      {@const y = 110 + (i * 9) % 80}
      {@const rx = 2.4 + (i % 3) * 0.8}
      <ellipse cx={x} cy={y} rx={rx} ry="1.1"
               fill={LMK.sage} stroke={ink} stroke-width="0.25" />
    {/each}
  </g>
  ...
  <g>
    ...
    <path d="M 240 116 Q 180 130 100 144 Q 40 154 0 162"
          stroke={LMK.earth} stroke-width="3" fill="none" opacity="0.55" stroke-linecap="round" />
    <path d="M 240 116 Q 180 130 100 144 Q 40 154 0 162"
          stroke={LMK.earthDark} stroke-width="0.6" fill="none" opacity="0.7" stroke-dasharray="2 3" />
    ...
    <!-- approaching trail -->
    <path d="M 240 116 Q 240 138 240 200" stroke={LMK.earth} stroke-width="3" fill="none" opacity="0.55" stroke-linecap="round" />
  </g>

  <!-- THE SIGNPOST — center, hero element -->
  <g transform="translate(240 116)">
    <!-- post -->
    <line x1="0" y1="0" x2="0" y2="-44" stroke="#4a3220" stroke-width="1.4" />
    <line x1="-0.7" y1="0" x2="-0.7" y2="-44" stroke="#3a2410" stroke-width="0.4" />
    <!-- base rocks -->
    <ellipse cx="0" cy="0.5" rx="4" ry="1" fill={LMK.earthDark} stroke={ink} stroke-width="0.35" />

    <!-- left board → Fort Bridger -->
    <g transform="translate(-1 -34) rotate(-12)">
      <path d="M -22 -3 L -2 -3 L 0 0 L -2 3 L -22 3 Z"
            fill={LMK.paperWarm} stroke={ink} stroke-width="0.55" />
      <text x="-12" y="0.6" font-size="3.2" font-family="IM Fell English, Georgia, serif"
            fill={ink} text-anchor="middle">
        FORT BRIDGER
      </text>
      <text x="-12" y="3.6" font-size="2.4" font-family="IM Fell English, Georgia, serif"
            fill={inkSoft} text-anchor="middle" font-style="italic">
        longer · water
      </text>
    </g>
    ...
    <g font-size="1.6" font-family="IM Fell English, Georgia, serif" fill="#3a2410" opacity="0.7">
      <text x="0" y="-12" text-anchor="middle">JFR · 1846</text>
      <text x="0" y="-9" text-anchor="middle">B·Y · 1847</text>
      <text x="0" y="-6" text-anchor="middle">PALMER 49</text>
    </g>
  </g>
  ...
  <g transform="translate(240 152)">
    ...
    <g transform="translate(0 -2)">
      <ellipse cx="0" cy="0" rx="3" ry="1.4" fill={LMK.earthDark} stroke={ink} stroke-width="0.3" />
      <ellipse cx="2.6" cy="-0.5" rx="1.2" ry="1.1" fill={LMK.earthDark} stroke={ink} stroke-width="0.3" />
    </g>
    <!-- wagon body, facing forward -->
    <rect x="-9" y="-7" width="18" height="3" fill={LMK.earth} stroke={ink} stroke-width="0.4" />
    <path d="M -9 -7 Q 0 -15 9 -7 Z" fill={LMK.white} stroke={ink} stroke-width="0.45" />
    <circle cx="-5" cy="-2" r="2.2" fill="none" stroke={ink} stroke-width="0.4" />
    <circle cx="5" cy="-2" r="2.2" fill="none" stroke={ink} stroke-width="0.4" />
    <!-- driver standing at front, hand raised -->
    <g transform="translate(-12 -8)">
      <ellipse cx="0" cy="0" rx="0.8" ry="0.9" fill={LMK.paperWarm} stroke={ink} stroke-width="0.25" />
      <path d="M -1 1 L 1 1 L 1.2 5 L -1.2 5 Z" fill={LMK.earthDark} stroke={ink} stroke-width="0.3" />
      <line x1="1" y1="2" x2="3" y2="-1" stroke={ink} stroke-width="0.4" />
      <path d="M -1.2 -0.8 L 1.2 -0.8 L 1 -1.4 L -1 -1.4 Z" fill={LMK.earthDark} stroke={ink} stroke-width="0.25" />
    </g>
  </g>
