<!--
  GuernseyRutsArt.svelte — sandstone cut by 5-ft-deep wagon ruts
...
<g>
  ...
  <g>
    ...
    <g stroke={stoneShDeep} stroke-width="0.55" fill="none" opacity="0.7">
  ...
  <g>
    ...
    <path d="M 200 60 L 280 60 L 320 156 L 160 156 Z"
          fill="#a89060" stroke={ink} stroke-width="0.55" />
  ...
  <g transform="translate(240 96)">
    ...
    <!-- wagon -->
    <rect x="-9" y="-9" width="18" height="3" fill={LMK.earth} stroke={ink} stroke-width="0.4" />
    <path d="M -9 -9 Q 0 -17 9 -9 Z" fill={LMK.white} stroke={ink} stroke-width="0.45" />
    <circle cx="-5" cy="-4" r="2.2" fill="none" stroke={ink} stroke-width="0.4" />
    <circle cx="5" cy="-4" r="2.2" fill="none" stroke={ink} stroke-width="0.4" />
  </g>

  <!-- a small carved name on the wall -->
  <text x="60" y="78" font-size="3" font-family="IM Fell English, Georgia, serif"
        fill={stoneShDeep} font-style="italic" opacity="0.7" transform="rotate(-3 60 78)">
    Bryant · 1846
  </text>
  <text x="412" y="76" font-size="3" font-family="IM Fell English, Georgia, serif"
        fill={stoneShDeep} font-style="italic" opacity="0.7" transform="rotate(2 412 76)">
    J·F·R · '46
  </text>
