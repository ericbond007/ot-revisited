...
{#snippet fordingWagon(x: number, y: number, opacity: number)}
  <g transform="translate({x} {y})" {opacity}>
    ...
    <g transform="translate(-26 -1)" opacity="0.85">
      <ellipse cx="0" cy="0" rx="2.6" ry="1.3" fill={LMK.earthLight} stroke={ink} stroke-width="0.3" />
      <ellipse cx="2.4" cy="-0.5" rx="1.1" ry="1" fill={LMK.earthLight} stroke={ink} stroke-width="0.3" />
    </g>
    <!-- wagon -->
    ...
    <circle cx="-6" cy="0" r="2.4" fill="none" stroke={ink} stroke-width="0.4" />
    <circle cx="6" cy="0" r="2.4" fill="none" stroke={ink} stroke-width="0.4" />
  </g>
{/snippet}
...
<g>
  ...
  <path d="M 0 86 Q 80 82 160 86 Q 240 80 320 86 Q 400 82 480 86 L 480 96 L 0 96 Z"
        fill="#a8a89a" opacity="0.55" stroke={ink} stroke-width="0.4" />
  <path d="M 0 96 Q 120 92 240 96 Q 360 92 480 96 L 480 102 L 0 102 Z"
        fill={LMK.sageDark} opacity="0.55" />

  <!-- willows along far bank -->
  <g>
    {#each [40, 80, 130, 200, 260, 340, 410, 460] as x, i}
      <ellipse cx={x} cy={104 + (i % 2) * 2} rx="6" ry="3"
               fill={LMK.sageDark} stroke={ink} stroke-width="0.3" opacity="0.85" />
    {/each}
  </g>
  ...
  <g>
    ...
    <path d="M 80 120 Q 200 122 320 120 Q 380 121 440 120 L 440 124 Q 200 126 60 124 Z"
          fill={sand} stroke={ink} stroke-width="0.4" opacity="0.85" />
    <!-- channel 2 (mid) -->
  ...
  <g>
    {@render fordingWagon(140, 120, 1)}
    {@render fordingWagon(210, 132, 1)}
    {@render fordingWagon(290, 144, 0.95)}
    {@render fordingWagon(360, 150, 0.85)}
    <!-- outrider -->
    <g transform="translate(80 122)">
      <ellipse cx="0" cy="-2" rx="3.5" ry="1.4" fill={LMK.water} opacity="0.5" />
      <ellipse cx="0" cy="-3" rx="3.5" ry="1.6" fill={LMK.earthDark} stroke={ink} stroke-width="0.3" />
      <ellipse cx="3" cy="-4.5" rx="1.4" ry="1.2" fill={LMK.earthDark} stroke={ink} stroke-width="0.3" />
      <ellipse cx="0" cy="-7" rx="0.9" ry="1" fill={LMK.paperWarm} stroke={ink} stroke-width="0.25" />
      <path d="M -1 -6 L 1 -6 L 0.8 -3 L -0.8 -3 Z" fill={LMK.earth} stroke={ink} stroke-width="0.25" />
    </g>
  </g>

  <!-- near bank — sandy strip foreground -->
  <path d="M 0 152 Q 240 154 480 152 L 480 164 L 0 164 Z" fill={sand} stroke={ink} stroke-width="0.5" />
  <rect x="0" y="164" width={LMK_VIEW_W} height="36" fill={LMK.parchment} opacity="0.55" />
  <!-- trail rut -->
  <path d="M 0 172 Q 120 170 240 174 Q 360 172 480 176" stroke={LMK.earth} stroke-width="0.9" fill="none" opacity="0.45" />
  <!-- sage clumps -->
  <g opacity="0.6">
    {#each [20, 70, 150, 240, 360, 440] as x, i}
